          ...
          <Card mode="elevated" style={styles.card}>
            ...
            <Card.Content>
              <Text style={styles.field}>
                ...
                {teacherInfo.data.descriptions}
              </Text>
              <Text style={styles.field}>
                <Text style={styles.label}>Created At:</Text>{" "}
                {new Date(teacherInfo.data.createdAt).toLocaleString()}
              </Text>
              <Text style={styles.field}>
                <Text style={styles.label}>Total Order:</Text>{" "}
                {teacherInfo.data.totalOrder}
              </Text>
              <Text style={styles.field}>
                <Text style={styles.label}>Department Name:</Text>{" "}
                {teacherInfo.data.departmentName}
              </Text>
              <Text style={styles.field}>
                <Text style={styles.label}>Degree:</Text>{" "}
                {teacherInfo.data.degree}
              </Text>
              <Text style={styles.field}>
                <Text style={styles.label}>Semester:</Text>{" "}
                {teacherInfo.data.semester}
              </Text>
              <Text style={styles.field}>
                <Text style={styles.label}>Subject Name:</Text>{" "}
                {teacherInfo.data.subjectName}
              </Text>
              <Text style={styles.field}>
                <Text style={styles.label}>Student Name:</Text>{" "}
                {teacherInfo.data.studentName}
              </Text>
            </Card.Content>
            <Card.Actions>
